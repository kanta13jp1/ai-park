...
const jumpSections: JumpSection[] = [
  {
    ...
    items: [
      { name: "Antigravity導入ガイド", href: "/guide", desc: "IDE / CLI セットアップとスラッシュコマンド", badge: "必読" },
      { name: "社内Skillsカタログ", href: "/skills-hub", desc: "自社業務特化スキル・申請・ワンクリック導入", badge: "人気" },
      { name: "MCP外部ツール連携", href: "/mcp-hub", desc: "社内DBやGoogle DriveとAntigravityの直結設定" },
      { name: "学習リソース & 勉強会", href: "/learning", desc: "全社員向け研修・過去勉強会アーカイブ動画", badge: "新着" },
      { name: "AI活用インタビュー", href: "/interviews", desc: "社内エンジニアのリアルな導入体験談・生の声" },
      { name: "Antigravity情報局", href: "/antigravity-info", desc: "CoE相談室・Office Hour予約窓口" },
    ],
  },
  {
    id: "agents",
